package com.enesorhan.kotlinmaps.adapter

import android.content.Intent
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.enesorhan.kotlinmaps.databinding.RecyclerRowBinding
import com.enesorhan.kotlinmaps.model.Place
import com.enesorhan.kotlinmaps.view.MapsActivity
...
class PlaceAdapter(val placeList: List<Place>) : RecyclerView.Adapter<PlaceAdapter.PlaceHolder>() {
    ...
    override fun onBindViewHolder(holder: PlaceHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("selectedItem",placeList.get(position))
